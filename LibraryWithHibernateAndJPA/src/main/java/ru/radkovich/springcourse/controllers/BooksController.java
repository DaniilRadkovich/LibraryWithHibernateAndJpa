...
import ru.radkovich.springcourse.services.BooksService;
...
public class BooksController {
    ...
    public String index(Model model, @RequestParam(value = "page", required = false) Integer page,
        ...
        if (pageIndex == null || booksPerPage == null)
            model.addAttribute("books", booksService.findAll(sortByYear));
        else
            model.addAttribute("books", booksService.findWithPagination(pageIndex, booksPerPage, sortByYear));
